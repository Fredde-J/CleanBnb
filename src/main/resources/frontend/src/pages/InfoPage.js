...
import { Card, CardTitle, CardText, Row, CardBody, Col } from "reactstrap";
  ...
  return (
    <Row>
      <Col xs="12" md={{ size: 8, offset: 2 }}>
        <Card style={cardStyle} className="my-3" color="warning">
          <CardBody>
            ...
            <CardText className="infopage-infoText">
              ...
              grund av vanligt slitage Vissa föremål, inklusive men inte
              begränsat till: konstverk; antikviteter, inklusive möbler och
              smycken; värdefulla mattor, samlarföremål; och andra föremål kan
              ha mer begränsat skydd under värdgarantin.
            </CardText>
            ...
            <CardText className="infopage-infoText infopage-infoTextBottom">
              Vänligen kontakta oss för att rapportera egendomsskada.
              Värdgarantin är inte en försäkringspolicy. I den mån du vill ha
              skydd utöver värdgarantin uppmuntrar Airbnb dig starkt att köpa
              försäkringar som täcker dig och din egendom gällande förluster
              orsakade av gäster, om din förlust inte ligger inom villkoren för
              värdgarantin.
            </CardText>
          </CardBody>
        </Card>
